...
import InputVehicleType from '../routes/InputVehicleType';
import InputFullPartTime from '../routes/InputFullPartTime';
...
function Register2({ navigation }) {
  ...
  //const fadeRegion = useRef(new Animated.Value(0)).current;
  ...
  const validate = (name, username, password, mobile, emergency, region, plate, owner, ic, license, front, back) => {
